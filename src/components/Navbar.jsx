...
const Navbar = () => {
  ...
  return (
    <div className='w-full h-20 bg-black z-99 flex items-center justify-between px-5 min-w-93.75'>
        {/* LOGO || NAME*/}
        <h1 className='uppercase text-white font-bold name shadow-sky-400 shadow-xl animate-pulse'>..Harsh..</h1>
